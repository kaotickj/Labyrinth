...
//=============================================================================
/*:
 * @plugindesc v1.0.2 Reads YEP (Yanfly) plugins activated in the 
 * project and outputs the correct plugin order.
 * @author Aloe Guvner & edited by ShadowDragon 
 * 
 * @param writeFile
 * @text Write File?
 * @type boolean
 ...
 * //=============================================================================
 * 
 * Version 1.0.1 (April 5 2021):
 * Updated the YEP manual List and re-order some to the correct space
 * 
...
(function () {
	...
	var manualKey = function manualKey() {
		return [
			...
			//"YEP_PictureAnimations" no order found on yanfly.moe (BETA PLUGIN)
		];
	};
